<?php
  ...
  $sql = "SELECT custName,COUNT(*) FROM Lease
GROUP BY custName,homePhone
HAVING COUNT(*) > 1";
...
<body>
  ...
  <div class="container">
    <div class="section">
      <h3>Customers Who Rented Multiple Properties</h3>
      <div class="row">
        <table class="striped centered">
	    <thead>
	      <TR><TH>Customer Name</TH><TH>Number of Leases</TH></TR>
	    </thead>
	  <?php
