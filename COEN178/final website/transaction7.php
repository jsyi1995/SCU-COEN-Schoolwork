<?php
  ...
  $sql = "SELECT * FROM Lease WHERE custName='$rentername'";
...
<body>
  ...
  <div class="container">
    <div class="section">
      <h3>View Lease Agreements for <?php echo $rentername; ?></h3>
      <div class="row">
        <table class="striped centered">
	    <thead>
	      <TR><TH>Property Number</TH><TH>Start Date</TH><TH>End Date</TH><TH>Customer Name</TH>
          <TH>Home Phone</TH><TH>Work Phone</TH><TH>Contact Name</TH><TH>Contact Phone</TH>
          <TH>Deposit Amount</TH><TH>Rent Amount</TH><TH>Supervisor Name</TH>
          </TR>
	    </thead>
	  <?php
