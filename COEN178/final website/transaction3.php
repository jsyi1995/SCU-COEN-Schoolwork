<?php
  ...
  $sql = "SELECT Property.propNum, Property.street, Property.city, Property.zip
	FROM Property JOIN Owner
...
<body>
  ...
  <div class="container">
    <div class="section">
      <h3>Properties Owned by <?php echo $ownername; ?></h3>
      <div class="row">
        <table class="striped centered">
	    <thead>
	      <TR><TH>Property Number</TH><TH>Street</TH><TH>City</TH><TH>Zip</TH></TR>
	    </thead>
	  <?php
      ...
      <div class="row">
          <div class="col s6">
            <p><b>Owner: </b><?php echo $ownername; ?></p>
          </div>
      </div>
    </div>
  </div>
